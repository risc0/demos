 ...
 */
export const readValueFromStorage = <T>(key: string) => {
	try {
...
export const isError = (value: StorageError | any): value is StorageError =>
	!!value?.error;

// biome-ignore lint/suspicious/noExplicitAny: ignore
export const setValueInStorage = <T = any>(key: string, value: T) => {
	try {
...
export const useLocalStorage = <T>(
	...
	const readValue = (): T => {
		...
		return isError(value) || isNil(value) || value === ""
			? initialValue
			: value;
	};
