...
export function Listener({ children }) {
  ...
  useEffect(() => {
    ...
    const metamaskButtonCallback = () => {
      const button: HTMLButtonElement | null = document.querySelector("#metamask");
  ...
  useEffect(() => {
    ...
    return observeAndClick("button.cl-profileSectionPrimaryButton__password", addWalletButtonCallback);
  }, []);
