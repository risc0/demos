...
import type { PrepareWriteContractResult, ReadContractResult, WriteContractMode } from "wagmi/actions";
...
export const zkKycABI = [
  ...
  },
  {
    ...
    inputs: [],
    name: "verifier",
    outputs: [{ name: "", internalType: "contract IRiscZeroVerifier", type: "address" }],
  },
] as const;
...
>(
  config: Omit<UseContractReadConfig<typeof zkKycABI, TFunctionName, TSelectData>, "abi" | "address"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractRead({
    abi: zkKycABI,
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof zkKycABI, "approve">["request"]["abi"],
        "approve",
        TMode
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<PrepareWriteContractResult<typeof zkKycABI, "burn">["request"]["abi"], "burn", TMode> & {
        address?: Address;
        chainId?: TChainId;
        functionName?: "burn";
      }
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<PrepareWriteContractResult<typeof zkKycABI, "mint">["request"]["abi"], "mint", TMode> & {
        address?: Address;
        chainId?: TChainId;
        functionName?: "mint";
      }
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof zkKycABI, "safeTransferFrom">["request"]["abi"],
        "safeTransferFrom",
        TMode
      > & {
        address?: Address;
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof zkKycABI, "setApprovalForAll">["request"]["abi"],
        "setApprovalForAll",
        TMode
      > & {
        address?: Address;
...
>(
  config: TMode extends "prepared"
    ? UseContractWriteConfig<
        PrepareWriteContractResult<typeof zkKycABI, "transferFrom">["request"]["abi"],
        "transferFrom",
        TMode
      > & {
        address?: Address;
...
export function usePrepareZkKycWrite<TFunctionName extends string>(
  config: Omit<UsePrepareContractWriteConfig<typeof zkKycABI, TFunctionName>, "abi" | "address"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return usePrepareContractWrite({
...
export function usePrepareZkKycApprove(
  config: Omit<UsePrepareContractWriteConfig<typeof zkKycABI, "approve">, "abi" | "address" | "functionName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return usePrepareContractWrite({
...
export function usePrepareZkKycBurn(
  config: Omit<UsePrepareContractWriteConfig<typeof zkKycABI, "burn">, "abi" | "address" | "functionName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return usePrepareContractWrite({
...
export function usePrepareZkKycMint(
  config: Omit<UsePrepareContractWriteConfig<typeof zkKycABI, "mint">, "abi" | "address" | "functionName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return usePrepareContractWrite({
...
export function usePrepareZkKycTransferFrom(
  config: Omit<UsePrepareContractWriteConfig<typeof zkKycABI, "transferFrom">, "abi" | "address" | "functionName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return usePrepareContractWrite({
...
export function useZkKycEvent<TEventName extends string>(
  config: Omit<UseContractEventConfig<typeof zkKycABI, TEventName>, "abi" | "address"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
...
export function useZkKycApprovalEvent(
  config: Omit<UseContractEventConfig<typeof zkKycABI, "Approval">, "abi" | "address" | "eventName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
...
export function useZkKycApprovalForAllEvent(
  config: Omit<UseContractEventConfig<typeof zkKycABI, "ApprovalForAll">, "abi" | "address" | "eventName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
...
export function useZkKycBurnedEvent(
  config: Omit<UseContractEventConfig<typeof zkKycABI, "Burned">, "abi" | "address" | "eventName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
...
export function useZkKycMintedEvent(
  config: Omit<UseContractEventConfig<typeof zkKycABI, "Minted">, "abi" | "address" | "eventName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
...
export function useZkKycTransferEvent(
  config: Omit<UseContractEventConfig<typeof zkKycABI, "Transfer">, "abi" | "address" | "eventName"> & {
    chainId?: keyof typeof zkKycAddress;
  } = {} as any,
) {
  return useContractEvent({
