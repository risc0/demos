  ...
  return (
    <Table>
      ...
      <TableBody>
        <TableRow>
          <TableCell>
            <span className={cn(starkData.status === "SUCCEEDED" && "text-green-600 dark:text-green-500")}>
          ...
          <TableCell>
            <div className="flex flex-col items-end">
              <span>
                <span className="text-muted-foreground">Segments:</span> {starkData.stats?.segments}
              </span>
              <span>
                <span className="text-muted-foreground">Cycles:</span> {starkData.stats?.cycles}
              </span>
              <span>
                <span className="text-muted-foreground">Total Cycles:</span> {starkData.stats?.total_cycles}
              </span>
            </div>
          </TableCell>
